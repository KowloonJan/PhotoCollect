<?php
$chiname = $_REQUEST['txtChiName'];
$engname = $_REQUEST['txtEngName'];
$phone = $_REQUEST['txtPhone'];
$email   = $_REQUEST['txtEmail'];
$posting = $_REQUEST['txtPosting'];
$votecast = $_REQUEST['txtVote'];


//database connection
include('dbConnect.php');

$sql = "INSERT into contact(chiname, engname, phone, email, posting, votecast) values(:chiname,:engname,:phone,:email,:posting,:votecast)";

$stmt = $pdo->prepare($sql);

$stmt->bindParam(":chiname",$chiname);
$stmt->bindParam(":engname",$engname);
$stmt->bindParam(":email",$email);
$stmt->bindParam(":phone",$phone);
$stmt->bindParam(":posting",$posting);
$stmt->bindParam(":votecast",$votecast);
               ...
               <div class="container">
                   <div class="row">
                       <div class="col-md-12">
                        ...
                        <H1 style="margin-top: 40px;">已成功投票! 多謝參與!</H1>
                       </div>
                       <div class="col-md-12">
                           <p><a href="cat1/page.html">繼續欣賞相片</a></p>
                       </div>
                   </div>
               </div>
           </section>
